...
public final class FridgeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<fridge.FridgeProto.FridgeStatusRequest,
      fridge.FridgeProto.FridgeStatusResponse> getGetFridgeStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFridgeStatus",
      requestType = fridge.FridgeProto.FridgeStatusRequest.class,
      responseType = fridge.FridgeProto.FridgeStatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<fridge.FridgeProto.FridgeStatusRequest,
      fridge.FridgeProto.FridgeStatusResponse> getGetFridgeStatusMethod() {
    io.grpc.MethodDescriptor<fridge.FridgeProto.FridgeStatusRequest, fridge.FridgeProto.FridgeStatusResponse> getGetFridgeStatusMethod;
      ...
      synchronized (FridgeServiceGrpc.class) {
        if ((getGetFridgeStatusMethod = FridgeServiceGrpc.getGetFridgeStatusMethod) == null) {
          FridgeServiceGrpc.getGetFridgeStatusMethod = getGetFridgeStatusMethod =
              io.grpc.MethodDescriptor.<fridge.FridgeProto.FridgeStatusRequest, fridge.FridgeProto.FridgeStatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFridgeStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fridge.FridgeProto.FridgeStatusRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<fridge.FridgeProto.FridgeStatusResponse,
      fridge.FridgeProto.FridgeControlRequest> getReportFridgeStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReportFridgeStatus",
      requestType = fridge.FridgeProto.FridgeStatusResponse.class,
      responseType = fridge.FridgeProto.FridgeControlRequest.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<fridge.FridgeProto.FridgeStatusResponse,
      fridge.FridgeProto.FridgeControlRequest> getReportFridgeStatusMethod() {
    io.grpc.MethodDescriptor<fridge.FridgeProto.FridgeStatusResponse, fridge.FridgeProto.FridgeControlRequest> getReportFridgeStatusMethod;
      ...
      synchronized (FridgeServiceGrpc.class) {
        if ((getReportFridgeStatusMethod = FridgeServiceGrpc.getReportFridgeStatusMethod) == null) {
          FridgeServiceGrpc.getReportFridgeStatusMethod = getReportFridgeStatusMethod =
              io.grpc.MethodDescriptor.<fridge.FridgeProto.FridgeStatusResponse, fridge.FridgeProto.FridgeControlRequest>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<fridge.FridgeProto.HealthCheckRequest,
      fridge.FridgeProto.HealthCheckResponse> getHealthCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "HealthCheck",
      requestType = fridge.FridgeProto.HealthCheckRequest.class,
      responseType = fridge.FridgeProto.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<fridge.FridgeProto.HealthCheckRequest,
      fridge.FridgeProto.HealthCheckResponse> getHealthCheckMethod() {
    io.grpc.MethodDescriptor<fridge.FridgeProto.HealthCheckRequest, fridge.FridgeProto.HealthCheckResponse> getHealthCheckMethod;
      ...
      synchronized (FridgeServiceGrpc.class) {
        if ((getHealthCheckMethod = FridgeServiceGrpc.getHealthCheckMethod) == null) {
          FridgeServiceGrpc.getHealthCheckMethod = getHealthCheckMethod =
              io.grpc.MethodDescriptor.<fridge.FridgeProto.HealthCheckRequest, fridge.FridgeProto.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "HealthCheck"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fridge.FridgeProto.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fridge.FridgeProto.HealthCheckResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getFridgeStatus(fridge.FridgeProto.FridgeStatusRequest request,
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<fridge.FridgeProto.FridgeStatusResponse> reportFridgeStatus(
        io.grpc.stub.StreamObserver<fridge.FridgeProto.FridgeControlRequest> responseObserver) {
     ...
     * </pre>
     */
    default void healthCheck(fridge.FridgeProto.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<fridge.FridgeProto.HealthCheckResponse> responseObserver) {
  ...
  public static final class FridgeServiceStub
     ...
     * </pre>
     */
    public void getFridgeStatus(fridge.FridgeProto.FridgeStatusRequest request,
        io.grpc.stub.StreamObserver<fridge.FridgeProto.FridgeStatusResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<fridge.FridgeProto.FridgeStatusResponse> reportFridgeStatus(
        io.grpc.stub.StreamObserver<fridge.FridgeProto.FridgeControlRequest> responseObserver) {
     ...
     * </pre>
     */
    public void healthCheck(fridge.FridgeProto.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<fridge.FridgeProto.HealthCheckResponse> responseObserver) {
  ...
  public static final class FridgeServiceBlockingStub
     ...
     * </pre>
     */
    public fridge.FridgeProto.FridgeStatusResponse getFridgeStatus(fridge.FridgeProto.FridgeStatusRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<fridge.FridgeProto.HealthCheckResponse> healthCheck(
        fridge.FridgeProto.HealthCheckRequest request) {
  ...
  public static final class FridgeServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<fridge.FridgeProto.FridgeStatusResponse> getFridgeStatus(
        fridge.FridgeProto.FridgeStatusRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FRIDGE_STATUS:
          serviceImpl.getFridgeStatus((fridge.FridgeProto.FridgeStatusRequest) request,
              (io.grpc.stub.StreamObserver<fridge.FridgeProto.FridgeStatusResponse>) responseObserver);
          break;
        ...
        case METHODID_HEALTH_CHECK:
          serviceImpl.healthCheck((fridge.FridgeProto.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<fridge.FridgeProto.HealthCheckResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              fridge.FridgeProto.FridgeStatusRequest,
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              fridge.FridgeProto.HealthCheckRequest,
              fridge.FridgeProto.HealthCheckResponse>(
  ...
  private static abstract class FridgeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fridge.FridgeProto.getDescriptor();
    }
